...
public class Ejercicio08CadenaGuia8 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El número de vocales en le frase es " + cadena.mostrarVocales(cadena.getFrase()) + " vocales");
